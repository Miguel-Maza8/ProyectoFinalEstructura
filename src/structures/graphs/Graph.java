...
/**
 * Grafo generico basado en lista de adyacencia, siguiendo la misma
 * estructura trabajada en clase (Map<Node<T>, Set<Node<T>>>).
 *
 * Se utilizan LinkedHashMap y LinkedHashSet en lugar de HashMap/HashSet
 * para conservar el orden de insercion de los nodos y de sus vecinos.
 * Esto es importante para el proyecto porque BFS y DFS deben producir
 * un orden de exploracion reproducible al recorrer graph.getVecinos(...).
 *
 * @param <T> tipo del valor almacenado en cada nodo (en este proyecto, MapPoint).
 */
